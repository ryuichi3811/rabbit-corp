export const Header = ({ dict }: { dict: { [key: string]: string } }) => {
  ...
  return (
    ...
    <div className="relative my-8 h-[100vw] w-full overflow-x-hidden md:h-[700px] md:pb-[calc(5%+16px)] md:pt-[5%]">
      {/* 画像 */}
      <div className="absolute bottom-0 right-0 h-full w-full bg-[url('/images/reve/top-header.png')] bg-no-repeat [background-size:100%] md:bottom-auto md:right-[5%] md:h-[86.5%] md:w-2/3  md:bg-[url('/images/reve/top-header.webp')]  md:bg-bottom lg:h-[82.5%] xl:h-[78.5%] xl:w-1/2"></div>
      {/* 見出し */}
